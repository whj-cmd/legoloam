...
//        subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>(pointCloudTopic, 1, &ImageProjection::cloudHandler, this);
        subLaserCloud = nh.subscribe<cloud_msgs::ground_estimate>(pointCloudTopic, 1, &ImageProjection::cloudHandler, this);
...
//    void copyPointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg){
    void copyPointCloud(const cloud_msgs::ground_estimate::ConstPtr& laserCloudMsg){

        cloudHeader = laserCloudMsg->header;
        // cloudHeader.stamp = ros::Time::now(); // Ouster lidar users may need to uncomment this line
//        pcl::fromROSMsg(*laserCloudMsg, *laserCloudIn);
        pcl::fromROSMsg(laserCloudMsg->curr, *laserCloudIn);
        if (alterGround)
            pcl::fromROSMsg(laserCloudMsg->ground,*groundCloud); // EDITED!
...
//            pcl::fromROSMsg(*laserCloudMsg, *laserCloudInRing);
            pcl::fromROSMsg(laserCloudMsg->curr, *laserCloudInRing);
...
//    void cloudHandler(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg){
    ...
    void groundRemoval_patchwork()
    {
        ...
        size_t rowIdn, columnIdn,gcloudSize = groundCloud->points.size();
        PointType thisPoint;
